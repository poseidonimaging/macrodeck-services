...
module ServicesModule
	module DefaultUUIDs
		...
		# FIXME: Prune those that we do not use; look into making DGROUP read DTYPE
		...
		DTYPE_COMMENTS		= "841d7152-1a50-43c5-b53f-75437faad6a2" # A data item's comments.
		DTYPE_COMMENT		= "9a232c1d-55f7-4edd-8b60-e942eca82ea2" # A comment inside of a comments group.
		...
		DTYPE_PLACE			= "76d337ea-2475-4fe5-8ab5-6389a7bd4405" # A place (eg. a restaurant, movie theater, etc.)
		DTYPE_CITY			= "b9291eac-c591-41ee-b3cd-d892ae6a9530" # A city (eg. a place where people live)
	end
end
